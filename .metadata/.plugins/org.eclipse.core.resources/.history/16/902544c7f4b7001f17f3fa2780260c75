    ...
    <div style="width: 100%; height: 100%; position: relative; background: #161622;">
        ...
        <div style="width: 335px; height: 116px; left: 20px; top: 516px; position: absolute;">
            ...
            <div style="width: 132px; height: 58px; left: 16px; top: 29px; position: absolute;">
                ...
                <div style="width: 102px; height: 13px; left: 0px; top: 0px; position: absolute; text-align: center; color: #9CB1D1; font-size: 11px; font-family: Poppins; font-weight: 400; line-height: 11px; word-wrap: break-word;">Enter Your Amount</div>
        ...
        <div style="width: 335px; height: 128px; left: 20px; top: 357px; position: absolute;">
            ...
            <div style="width: 48px; height: 68px; left: 12px; top: 46px; position: absolute;">
                <div style="width: 23px; height: 13px; left: 13px; top: 55px; position: absolute; color: white; font-size: 11px; font-family: Poppins; font-weight: 400; line-height: 11px; word-wrap: break-word;">Add</div>
